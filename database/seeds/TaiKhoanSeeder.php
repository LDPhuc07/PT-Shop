...
class TaiKhoanSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tai_khoans')->insert([
            ...
            ['id'=> 6, 'ho_ten'=>'Nguyễn Văn F','email'=>'fbc@gmail.com', 'password'=>bcrypt('123456'), 'so_dien_thoai'=>'0123456784', 'dia_chi'=>'khánh hòa', 'admin'=>false, 'remember_token'=>null, 'trang_thai'=>true],
            ['id'=> 7, 'ho_ten'=>'Nguyễn Văn G','email'=>'gbc@gmail.com', 'password'=>bcrypt('123456'), 'so_dien_thoai'=>'0123456783', 'dia_chi'=>'khánh hòa', 'admin'=>false, 'remember_token'=>null, 'trang_thai'=>true],
